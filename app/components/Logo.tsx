    ...
    >
      ...
      {withText && (
        <div className="flex flex-col">
          <span
            className={`${textSizes[size]?.main || "text-2xl"} font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-700 to-blue-900`}
          >
            React
          </span>
          <span
            className={`${textSizes[size]?.sub || "text-sm"} font-medium bg-clip-text text-transparent bg-gradient-to-r from-orange-600 to-orange-800 -mt-1`}
          >
            on AWS S3
          </span>
        </div>
